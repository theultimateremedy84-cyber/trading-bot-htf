    ...
    <div className="min-w-0 space-y-5 sm:space-y-6">
      ...
      <div className="grid gap-3 sm:gap-4 md:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold font-mono">{performance ? formatPercentage(performance.winRate * 100) : "-"}</div>
      ...
      <div className="grid min-w-0 gap-4 md:grid-cols-7">
        ...
        <Card className="min-w-0 border-border md:col-span-2">
          <CardHeader><CardTitle className="text-sm font-semibold uppercase text-muted-foreground">Recent Signals</CardTitle></CardHeader>
          <CardContent className="px-2">
            <div className="space-y-1">
              {signals?.map((signal) => (
                <div key={signal.id} className="flex flex-col gap-1 rounded-sm border-b border-border/50 p-2 transition-colors last:border-0 hover:bg-muted/30">
